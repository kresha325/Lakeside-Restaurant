...
export const categories: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      item('sk2', L('Qofte shtëpie', 'House meatballs'), 6),
      item('sk3', L('File Pule', 'Chicken fillet'), 7),
      item('sk4', L('Kotlet viçi', 'Veal chop'), 14),
      item('sk5', L('Taraget', 'Prime Ribeye'), 14),
      item('sk6', L('Ramstek', 'New York strip'), 14),
      item('sk7', L('Kombinim Mishi', 'Meat combination'), 16),
      item('sk8', L('Mish Viçi', 'Veal meat'), 17),
      item('sk9', L('Biftek', 'Filet mignon'), 18),
      item('sk10', L('Medaljon viçi', 'Veal medallions'), 18),
      item('sk11', L('File Mignon Estragoni', 'Filet mignon with tarragon'), 18),
    ],
  },
  {
    id: 'furra',
