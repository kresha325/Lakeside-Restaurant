...
export const categories: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      item('pf2', L('Tarator', 'Tarator'), 2.5),
  ...
  },
  {
    ...
    items: [
      ...
      item('sk3', L('Kotlet viçi', 'Veal cutlet'), 14),
      item('sk4', L('Taraget', 'T-bone steak'), 14),
      item('sk5', L('Ramstek', 'Rump steak'), 14),
      item('sk6', L('Kombinim Mishi', 'Meat combination'), 16),
      item('sk7', L('Mish Viçi', 'Veal meat'), 17),
      item('sk8', L('Biftek', 'Beef steak'), 18),
